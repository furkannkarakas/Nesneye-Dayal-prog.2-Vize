...
public class Main {
    ...
    public static void ornekVeriEkle(BiletSistemi biletSistemi) {
        var film1 = new Film("AROG", "Komedi", 169, "Cem Yılmaz");
        var film2 = new Film("Recep İvedik", "Komedi", 148, "Şahan Gökbakar");
        var film3 = new Film("IRONMAN", "Bilim Kurgu", 152, "Jon Favreau");

        biletSistemi.filmListesineEkle(film1);
        biletSistemi.filmListesineEkle(film2);
        biletSistemi.filmListesineEkle(film3);

        var musteri1 = new Musteri("Furkan", "Aktif", "furkan@g.com", "1234567890");
        var musteri2 = new Musteri("Cem", "Pasif", "cem@g.com", "0987654321");
        var musteri3 = new Musteri("Adil", "Aktif", "adil@gm.com","0129192");

        biletSistemi.musteriListesineEkle(musteri1);
        biletSistemi.musteriListesineEkle(musteri2);

        var salon1 = new Salon("Salon A", "Aktif", 100, "IMAX", film1);
        var salon2 = new Salon("Salon B", "Pasif", 150, "6DX", film2);
